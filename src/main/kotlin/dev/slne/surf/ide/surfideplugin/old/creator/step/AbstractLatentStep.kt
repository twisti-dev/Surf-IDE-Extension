...
import dev.slne.surf.ide.surfideplugin.old.util.asyncIO
import dev.slne.surf.ide.surfideplugin.old.util.invokeLater
import dev.slne.surf.ide.surfideplugin.old.util.onHidden
import dev.slne.surf.ide.surfideplugin.old.util.onShown
            ...
            invokeLater {
                ...
                if (result == null) {
                    placeholder.component = panel {
                        row {
                            val labelValidationText = "Unable to $description due to an error: $errorMessage"
        ...
        placeholder.component = panel {
            row(description.capitalize()) {
                cell(
                    ...
                    .validation(
                        DialogValidation {
                            ValidationInfo("Haven't finished $description")
                        }
                    )
            }
        }
